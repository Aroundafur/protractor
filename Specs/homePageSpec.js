var HomePage = function() {
    ...
    this.centerStageButtons = element(by.xpath("//*[contains(@class,'stage-buttons')]"));
    this.viewOnGitHubButton = this.centerStageButtons.all(by.xpath("//*[contains(@class,'btn-large')]")).get(0);
    this.downloadButton = this.centerStageButtons.element(by.xpath("//*[contains(@class,'download-btn')]"));
    this.designDocsButton = this.centerStageButtons.element(by.xpath("//*[contains(@class,'btn-warning')]"));
}
